...
# TODO ну ты чет опять, просто закомментил то что я написал и
#  все, ну я зря что ли это делаю? я в целом могу не делать, просто буду чекать на факт, работает или нет и все,
#  но это ты и сам проверить можешь
